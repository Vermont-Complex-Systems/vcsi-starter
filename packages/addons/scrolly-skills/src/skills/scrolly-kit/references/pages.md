...
- **Start with the home page.** It is ordinary user-owned Svelte, styled with `.page` and tokens. Most "customize the site" requests are just editing it; don't invent new machinery for the easy case.
