...
//
// Singleton DuckDB-WASM instance. Browser-only.
// Guard usage with `import { browser } from '$app/environment'`.
 ...
 * Lazily loads the WASM bundle on first call via jsDelivr CDN.
 */
...
/**
 * Load a DuckDB extension (e.g. 'spatial', 'json').
 */
...
/**
 * Register a parquet file by URL so DuckDB can query it.
 */
